...
import github.karakoukie.jumlcreator.classes.JClassAccessibility;
...
public class AddClassDialog extends java.awt.Dialog {
    ...
    public final JClassAccessibility getAccessibility() {
        return JClassAccessibility.getFromName(
