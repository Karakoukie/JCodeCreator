...
public class OptionsDialog extends java.awt.Dialog {
    ...
    private void initComponents() {
        ...
        jLabelProjectName.setText("Default author :");
        ...
        jLabelProjectName1.setText("Language :");
        ...
        jPanelProjectName1.add(jComboBox1);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OptionsDialog dialog = new OptionsDialog(new java.awt.Frame());
