 ...
 */
public class RenameDialog extends java.awt.Dialog {
    ...
    private void initComponents()
    {
        ...
        setPreferredSize(new java.awt.Dimension(663, 320));
    ...
    public final void setDefaultName(final String name) {
        this.jTextFieldProjectName.setText(name);
        setAvailableName(false);
    }
    
    public final void setDefaultDescription(final String description) {
        this.jTextAreaDesc.setText(description);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RenameDialog dialog = new RenameDialog(new java.awt.Frame());
