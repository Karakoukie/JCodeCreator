...
import github.karakoukie.jumlcreator.classes.methods.JProperty;
 ...
 */
public class AddPropertyDialog extends java.awt.Dialog {
     ...
     * @param parent
     */
    public AddPropertyDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelProtected.setLabelFor(jCheckBoxFinal);
        jLabelProtected.setText("Is final :");
        jLabelProtected.setPreferredSize(new java.awt.Dimension(238, 16));
        jPanelPackageProtected.add(jLabelProtected);

        jCheckBoxFinal.setSelected(true);
        jCheckBoxFinal.setPreferredSize(new java.awt.Dimension(238, 28));
        jPanelPackageProtected.add(jCheckBoxFinal);

        jPanelBody.add(jPanelPackageProtected);

        jLabelExtension.setLabelFor(jComboBoxReturn);
        jLabelExtension.setText("Type :");
        ...
        jLabelExtension1.setText("Custom type :");
    ...
    public final JProperty getProperty() {
        final JProperty property = new JProperty();
        property.setName(getPropertyName());
        property.setDescription(getDescription());
        property.setIsFinal(isFinal());
        property.getData().setDataType(JDataType.getFromName(getReturnName()));
        property.getData().setCustomDataType(getCustomReturnName());
        return property;
    }
    ...
    public final void setAbstract(final boolean value) {
        jCheckBoxFinal.setSelected(value);
    }
    
    public final boolean isFinal() {
        return jCheckBoxFinal.isSelected();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddPropertyDialog dialog = new AddPropertyDialog(new java.awt.Frame());
