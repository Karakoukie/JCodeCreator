...
public class AddConstructorDialog extends java.awt.Dialog {
     ...
     * @param parent
     */
    public AddConstructorDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
        ...
        this.fieldsPanel.setOnAddCallback(() -> {
            properties.add((JProperty) fieldsPanel.getElement());
        });
        jPanelFields.add(fieldsPanel);
    }

    public final JConstructor getConstructor() {
        final JConstructor constructor = new JConstructor();
        
        constructor.setName(getFieldName());
        constructor.setDescription(getDescription());
        
        for (JProperty property : properties) {
            constructor.addProperty(property);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddConstructorDialog dialog = new AddConstructorDialog(new java.awt.Frame());
