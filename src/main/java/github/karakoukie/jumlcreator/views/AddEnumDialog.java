 ...
 */
public class AddEnumDialog extends java.awt.Dialog {
     ...
     * @param parent
     */
    public AddEnumDialog(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelExtension.setText("Implemented interface :");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddEnumDialog dialog = new AddEnumDialog(new java.awt.Frame());
