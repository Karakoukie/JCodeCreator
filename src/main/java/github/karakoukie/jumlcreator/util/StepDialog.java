...
public class StepDialog extends JDialog {
    ...
    private final CardPanel headerPanel;
    private final TitledPanel stepsPanel;
    private final JPanel bodyPanel;
    private final CardPanel footer;
    ...
    public StepDialog(final JFrame owner) {
        super(owner, true);
        this.setResizable(false);

        this.headerPanel = new CardPanel();
        this.stepsPanel = new TitledPanel("Steps");
        this.bodyPanel = new JPanel();
        this.footer = new CardPanel();
        ...
        this.footer.add(navigationPanel);
    ...
    public static final void main(String[] args) {
        ...
        final StepDialog dialog = new StepDialog(null);
