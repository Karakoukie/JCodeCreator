...
public class StepPanel extends JPanel {
    ...
    private final CardPanel controlCardPanel;
    private final ControlPanel controlPanel;
    private final boolean mandatory;
    private final CardPanel errorCardPanel;
    ...
    public StepPanel(final String title, final int lineWidth, 
        ...
        super();
        this.title = title;
        this.controlCardPanel = new CardPanel();
        this.controlPanel = new ControlPanel(title, lineWidth);
        this.mandatory = mandatory;
        this.errorCardPanel = new CardPanel();
        this.errorTitledPanel = new TitledPanel(null);
        this.errorTitledPanel.setPreferredSize(new Dimension(lineWidth, 50));
        ...
        this.errorTitledPanel.add(errorLabel);
